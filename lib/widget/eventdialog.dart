...
Future<EventModel?> addEventDialog(BuildContext context) {
  ...
  String selectedCategory =expenseCategories.isNotEmpty ? expenseCategories.first : '';
    ...
    builder: (context) {
      return StatefulBuilder(
        builder: (context, setState) {
          ...
          final double splitAmount =members > 0 ? totalAmount / members : 0;
